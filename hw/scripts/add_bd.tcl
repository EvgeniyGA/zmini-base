...
if [file exists $bd_src] {
	...
	make_wrapper -files [get_files ${work_dir}/${project_name}.srcs/sources_1/bd/bd/bd.bd] -top
	add_files -norecurse ${work_dir}/${project_name}.srcs/sources_1/bd/bd/hdl/bd_wrapper.v
